...
// -----Parameters-----
// --------------------
float angular_resolution = 0.35f;
...
/*void setViewerPose (pcl::visualization::PCLVisualizer& viewer, const Eigen::Affine3f& viewer_pose)
{
  ...
  viewer.setCameraPosition(pos_vector[0], pos_vector[1], pos_vector[2],
                           ...
                           up_vector[0], up_vector[1], up_vector[2],1);
}
*/
// --------------
// -----Main-----
...
void getNearK(pcl::PointXYZ search, const boost::shared_ptr<const pcl::PointCloud<pcl::PointXYZ> > &src,int order)
{
...
int main (int argc, char** argv)
{
 ...
 // std::string filename = "./outdata1.pcd";
  ...
  viewer.setBackgroundColor (0, 206, 209);
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointWithRange> range_image_color_handler(range_image_ptr, 0, 0, 0);
  viewer.addPointCloud (range_image_ptr, range_image_color_handler, "range image");
  viewer.setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "range image");
//  viewer.addCoordinateSystem (1.0f, "global");
  pcl::visualization::PointCloudColorHandlerCustom<PointType> point_cloud_color_handler(point_cloud_ptr, 160, 82, 45);
 ...
 // setViewerPose (viewer, range_image.getTransformationToWorldSystem ());
  ...
  narf_keypoint_detector.getParameters ().distance_for_additional_points = 100.0f;
 ...
 // for (size_t i=0; i<keypoint_indices.points.size (); ++i)
  //  range_image_widget.markPoint(static_cast<uint32_t>(keypoint_indices.points[i]%range_image.width),
   // 		static_cast<uint32_t>(keypoint_indices.points[i]/range_image.width));
  // --------------------- ----------------
  ...
  for (size_t i=0; i<keypoint_indices.points.size (); ++i)
  {
    ...
    std::cout <<"keypoints: " << i << "::"
			  ...
			  << keypoints.points[i].z << std::endl;

    	getNearK(keypoints.points[i],point_cloud_ptr,i);
